...
class HGM_UNet3D(nn.Module):
    def __init__(self, input_ch=1, output_ch=1, init_feats=32):
        super(HGM_UNet3D, self).__init__()
        ...
        self.final_conv = nn.Conv3d(init_feats, output_ch, kernel_size=1, stride=1)
...
#     model = HGM_UNet3D(init_feats=16)
